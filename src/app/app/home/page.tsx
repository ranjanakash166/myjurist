            ...
            {documentFeatures.map((feature, index) => {
              ...
              return (
                <Link key={index} href={feature.href} className="group">
                  <Card className="bg-card border border-border hover:border-primary/40 bg-gradient-to-br from-card to-primary/5 dark:to-primary/10 hover:scale-[1.02] hover:shadow-xl transition-all duration-300 cursor-pointer h-full">
