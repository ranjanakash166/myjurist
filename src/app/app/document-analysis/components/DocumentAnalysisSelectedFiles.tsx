...
import { formatFileSize } from "../lib/documentAnalysisUtils";

const ACCEPTED_TYPES = ".pdf,.doc,.docx,.txt,.rtf";

interface DocumentAnalysisSelectedFilesProps {
  files: File[];
  uploading: boolean;
  uploadError: string | null;
  onSelectFiles: (files: FileList) => void;
  onRemoveFile: (index: number) => void;
  onProceedAndUpload: () => void;
}

export default function DocumentAnalysisSelectedFiles({
  files,
  uploading,
  uploadError,
  onSelectFiles,
  onRemoveFile,
  onProceedAndUpload,
}: DocumentAnalysisSelectedFilesProps) {
