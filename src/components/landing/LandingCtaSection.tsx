  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto text-center flex flex-col items-center gap-4 sm:gap-6 w-full">
        ...
        <Button
          asChild
          className="landing-cta-button landing-cta-text font-medium transition-all duration-200 ease-out hover:scale-105 hover:shadow-xl hover:brightness-110 active:scale-100"
        >
