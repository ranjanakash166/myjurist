...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gradient-to-t from-slate-100/80 to-slate-50/40 dark:from-slate-900/80 dark:to-slate-800/40 py-12 border-t border-ai-blue-500/20">
      <div className="max-w-6xl mx-auto px-4 text-center">
        <div className="flex items-center justify-center space-x-3 mb-6 group">
          ...
          <span className="text-2xl font-bold gradient-text-animate text-slate-800 dark:text-white">
            My Jurist
          </span>
        </div>
        
        <p className="text-slate-500 dark:text-slate-400 mb-8 text-lg">Next Gen AI Law Firm</p>
        ...
        <div className="mt-8 pt-8 border-t border-ai-blue-500/20">
          <p className="text-slate-400 dark:text-slate-500">&copy; 2025 My Jurist. All rights reserved.</p>
          <div className="mt-4 flex justify-center space-x-6 text-sm text-slate-400 dark:text-slate-500">
