    ...
    <footer className="bg-gradient-to-t from-slate-900/80 to-slate-800/40 py-12 border-t border-ai-blue-500/20">
      <div className="max-w-6xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-8 mb-8">
          ...
          <button className="group border-2 border-ai-blue-500 text-ai-blue-400 hover:bg-ai-blue-500 hover:text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 flex items-center hover:shadow-lg hover:shadow-ai-blue-500/25">
